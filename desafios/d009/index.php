...
<body>
    ...
    <section>
        ...
        <h2>Cálcudo das Médias.</h2>
        <p>Analisando os valores <?=$valor1?> e <?=$valor2?>:</p>

        <ul>
            <li><strong>A Média Aritimética Simples</strong> os valores é igual a <?=number_format($ma, 2, ",",".")?></li>
            <li><strong>A Média Ponderada</strong>com pesos <?=$peso1?> e <?=$peso2?>é igual a <?=number_format($mp, 2, ",",".")?></li>
        </ul>
    </section>
</body>
</html>